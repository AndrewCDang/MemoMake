        ...
        <div className={styles.logoContainer}>
            <Link href={isLoggedIn ? "/dashboard" : "/"}>
                <svg
                    id="a"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 27.14 21.53"
                >
                    <path
                        d="M10.49,12.58l-2.3,8c0,.1-.1,.2-.2,.2H.99c-.2,0-.3-.2-.2-.3L3.09,12.48c0-.1,.1-.2,.2-.2h7c.1,0,.3,.1,.2,.3Z"
                        fill="white"
                        stroke="black"
                        strokeWidth="1.5"
                    />
                    <path
                        d="M21.69,11.48c.7,0,1.1,.6,1,1.3l-2.3,8c-.1,.4-.5,.7-1,.7h-7c-.7,0-1.1-.6-1-1.3l2.3-8c.1-.4,.5-.7,1-.7,0,0,7,0,7,0Z"
                        fill="#FFC700"
                    />
                    <path
                        d="M14.99,1.08l-2.5,8c0,.1-.1,.2-.2,.2H4.49c-.2,0-.3-.2-.2-.3L6.79,.98c0-.1,.1-.2,.2-.2h7.8c.1-.1,.2,.1,.2,.3Z"
                        fill="white"
                        stroke="black"
                        strokeWidth="1.5"
                    />
                    <path
                        d="M26.39,1.08l-2.5,8c0,.1-.1,.2-.2,.2h-7.8c-.2,0-.3-.2-.2-.3L18.19,.98c0-.1,.1-.2,.2-.2h7.8c.1,0,.2,.1,.2,.3Z"
                        fill="white"
                        stroke="black"
                        strokeWidth="1.5"
                    />
