...
export const CollectionIcon = () => {
    return (
        <svg viewBox="0 0 36 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M12.3274 17.5776L31.3274 10.7924C32.6299 10.3272 34 11.2928 34 12.6759V36.7542C34 37.6041 33.4629 38.3612 32.6607 38.6419L13.6607 45.2919C12.3604 45.7471 11 44.7819 11 43.4042V19.4611C11 18.6159 11.5314 17.8619 12.3274 17.5776Z"
                fill="white"
                stroke="black"
                stroke-width="4"
            />
